...
const TeamMemberCard: React.FC<TeamMember> = ({ name, role }) => (
  <div className="relative group overflow-hidden aspect-[3/4]">
    <div className="absolute inset-0 bg-gray-800 flex items-center justify-center transition-opacity duration-300 group-hover:opacity-0">
...
const TeamSection: React.FC = () => {
  return (
    <section id="team" className="py-16 md:py-24 bg-brand-primary">
