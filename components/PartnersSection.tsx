  ...
  return (
    <div className="flex-shrink-0 mx-6 md:mx-10">
      <img
        src={logoSrc}
        alt={alt}
        className="h-32 md:h-36 w-auto object-contain opacity-70 hover:opacity-100 transition-all duration-300 cursor-pointer"
      />
    </div>
  );
};
...
const PartnersSection: React.FC = () => {
  ...
  return (
    <section id="partners" className="pt-24 md:pt-32 pb-8 md:pb-12 bg-white dark:bg-brand-primary">
