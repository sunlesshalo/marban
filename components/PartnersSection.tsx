...
const PartnersSection: React.FC = () => {
  ...
  return (
    <section id="partners" className="py-16 md:py-24 bg-brand-primary">
      <div className="container mx-auto px-6 text-center">
        <h2 className="text-3xl md:text-4xl font-bold text-white tracking-tight">
          Trusted by Industry Leaders
        </h2>
        <p className="mt-4 max-w-3xl mx-auto text-lg text-brand-secondary">
      ...
      <div className="mt-12 w-full overflow-hidden relative">
        <div className="absolute inset-y-0 left-0 w-24 bg-gradient-to-r from-brand-primary to-transparent z-10"></div>
        <div className="absolute inset-y-0 right-0 w-24 bg-gradient-to-l from-brand-primary to-transparent z-10"></div>
